...
<div class="card">
    ...
    <div class="filter-bar">
        <form method="GET" action="{{ route('hr.leaves.index') }}" class="d-flex flex-wrap gap-2 w-100">
            ...
            <a href="{{ route('hr.leaves.index') }}" class="btn btn-outline-secondary btn-sm">Clear</a>
            @endif
        </form>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-4">
                            <a href="{{ route('hr.leaves.show', $leave) }}" class="btn btn-sm btn-outline-primary">
                                <i class="bi bi-eye"></i>
                            </a>
                        </td>
                    </tr>
