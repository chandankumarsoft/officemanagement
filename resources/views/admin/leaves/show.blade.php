    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-white d-flex align-items-center gap-2 py-3 px-4">
                <a href="{{ route('admin.leaves.index') }}" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left"></i></a>
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        @error('approval_remarks')<div class="text-danger small">{{ $message }}</div>@enderror
                    </div>
                </div>
