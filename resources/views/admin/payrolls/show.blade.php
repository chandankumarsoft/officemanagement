    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-header bg-white d-flex align-items-center gap-2 py-3 px-4">
                ...
                <h5 class="mb-0 fw-bold"><i class="bi bi-cash-stack me-2 text-success"></i>Payroll Slip</h5>
                <span class="ms-auto badge {{ $payroll->status === 'paid' ? 'bg-success' : 'bg-warning text-dark' }} fs-6">
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-sm">
                            <tr><td class="text-muted">Tax Deduction</td><td class="text-end fw-semibold">${{ number_format($payroll->tax_deduction, 2) }}</td></tr>
                ...
                <div class="d-flex justify-content-end mt-4 gap-2">
                    <form action="{{ route('admin.payrolls.markAsPaid', $payroll) }}" method="POST">
                        @csrf
                        <button class="btn btn-success" onclick="return confirm('Mark as paid?')">
